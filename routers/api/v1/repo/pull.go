...
func UpdatePullRequest(ctx *context.APIContext) {
	...
	if err = pull_service.Update(graceful.GetManager().ShutdownContext(), pr, ctx.Doer, message, rebase, repo_model.MergeStrategyDefault, repo_model.MergeStrategyOptionNone); err != nil {
