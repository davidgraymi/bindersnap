...
import {useHorizontalRule} from './use-horizontal-rule.ts';
...
<template>
  <button
    v-if="isVisible" type="button" class="tiptap-button" data-style="ghost" :disabled="!canInsert"
    :data-disabled="!canInsert" :aria-label="label" :data-tooltip-content="label" @click="onClick"
  >
